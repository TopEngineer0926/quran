...
class PendingRecitationController extends CrudController
{
    public $model = 'Recitation';
    public $route = 'pending-recitation';
    public $view = 'admin.view';
    private $title = 'Pending Recitations';
    ...
    public function show($qari)
    {
        ...
        $resource = Recitation::select('id', 'surah_id',  'name',  'qari_id'  )->where('qari_id',$qari)->with('qari')->where('surah_id',0)->orderBy('surah_id', 'asc')->get();
