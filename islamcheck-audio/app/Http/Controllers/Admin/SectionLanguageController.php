...
class SectionLanguageController extends CrudController
{
    public $model = 'Section';
    public $route = 'section_language';
    public $view = 'admin.view';
    private $title = 'Section Language';
    ...
    public function index()
    {
        ...
        }])->where('language_code',$language)->where('source_type','section')->get()   ;
    ...
    public function create()
    {
        ...
        $page = new Page($this->title,$this->title);
        $form = $page->form(route('section_language.store'));
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $sql = "DELETE FROM translations WHERE language_code='$language->code' and source_type='section'";
