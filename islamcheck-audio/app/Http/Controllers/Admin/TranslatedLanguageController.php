...
class TranslatedLanguageController extends CrudController
{
    public $model = 'Language';
    public $route = 'translated_language';
    public $view = 'admin.view';
    private $title = 'Trasnlated Language';
    ...
    public function index()
    {
        ...
        }])->where('language_code',$language)->where('source_type','language')->get()   ;
    ...
    public function create()
    {
        ...
        $page = new Page($this->title,$this->title);
        $form = $page->form(route('translated_language.store'));
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $sql = "DELETE FROM translations WHERE language_code='$language->code' and source_type='language'";
