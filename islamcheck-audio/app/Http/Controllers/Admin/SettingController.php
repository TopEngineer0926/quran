...
class SettingController extends CrudController
{
    ...
    public function index()
    {
        ...
        $resource = Translation::select('id',  'name', 'original_name','language_code')->with(['language' => function ($query ) use ($language) {
            $query->where('code',$language);
        }])->where('language_code',$language)->where('source_type','other')->get()   ;
        ...
        $table = $page->table([  'ID', 'Name','English Name','Language' ],$this->route);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $sql = "DELETE FROM translations WHERE language_code='$language->code' and source_type='other'";
